...
public class 배열응용_1 {
	/*
	 * 1869| 트랜센던스| 액션, 드라마, SF, 스릴러|
	 * https://movie-phinf.pstatic.net/20140508_286/1399516260430nO8Ry_JPEG/
	 * movie_image.jpg?type=m77_110_2| 조니 뎁(윌 캐스터), 레베카 홀(에블린), 모건 프리먼(요셉 태거)| 2014
	 * .05.14 개봉| 12세 관람가| 월리 피스터
	 */
	public static void main(String[] args) throws Exception {
		...
		/*
		 * class Movie { String mno,title,genre,poster,actor,regdate,grade,director }
		 * 
		 * Movie m=new Movie()
		 */
		i = 0;
		 ...
		 * 
		 * // 2. 장르 for (String s : genres) { System.out.println(s); }
		 */
